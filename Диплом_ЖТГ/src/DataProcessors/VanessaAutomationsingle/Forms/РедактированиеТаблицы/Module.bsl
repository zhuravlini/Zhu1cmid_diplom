...
Процедура ЗагрузитьТаблицуСервер(МассивСтрокДляРедактирования = Неопределено)
	...
	Для Каждого Колонка Из ПромТаблица.Колонки Цикл 
		...
		Если (Лев(ЭлементСпискаКолонок.Представление,1) = "'" И Прав(ЭлементСпискаКолонок.Представление,1) = "'")
			ИЛИ (Лев(ЭлементСпискаКолонок.Представление,1) = """" И Прав(ЭлементСпискаКолонок.Представление,1) = """") Тогда
