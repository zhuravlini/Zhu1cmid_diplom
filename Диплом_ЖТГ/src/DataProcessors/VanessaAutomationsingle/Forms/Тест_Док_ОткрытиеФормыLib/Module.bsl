...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯНабираюТекст(Парам01)","ЯНабираюТекст","И я набираю текст ""текст""","Если включено использование компоненты VanessaExt, то эмулирует ввод клавиш клавиатуры с помощью компоненты.
		|Иначе эмулирует ввод текста с помощью утилиты KeyboardType (устарело). Возможен ввод на русском и английском языке. Для переключения расскладки эмулируется сочетание клавиш Ctrl+Shift.
		|Рекомендуется включить использование компоненты VanessaExt.","Прочее.Ввод текста");
