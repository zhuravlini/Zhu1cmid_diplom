...
Функция ЯОткрываюОбщуюФорму(Знач ИмяОбъекта) Экспорт
	...
	ОткрытьФормуЧерезНавигационнуюСсылку("e1cib/list/ОбщаяФорма." + ИмяОбъекта);
...
Функция ЯОткрываюОсновнуюФормуОбработки(Знач ИмяОбъекта) Экспорт
	...
	ОткрытьФормуЧерезНавигационнуюСсылку("e1cib/app/Обработка." + ИмяОбъекта);
...
Функция ЯОткрываюОсновнуюФормуОтчета(Знач ИмяОбъекта) Экспорт
	...
	ОткрытьФормуЧерезНавигационнуюСсылку("e1cib/app/Отчет." + ИмяОбъекта);
...
Функция ЯОткрываюОсновнуюФормуСправочника(Знач ИмяОбъекта) Экспорт
	...
	ОткрытьФормуЧерезНавигационнуюСсылку("e1cib/data/Справочник." + ИмяОбъекта);
...
Функция ЯОткрываюОсновнуюФормуСпискаСправочника(Знач ИмяОбъекта) Экспорт
	...
	ОткрытьФормуЧерезНавигационнуюСсылку("e1cib/list/Справочник." + ИмяОбъекта);
...
Функция ЯОткрываюОсновнуюФормуДокумента(Знач ИмяОбъекта) Экспорт
	...
	ОткрытьФормуЧерезНавигационнуюСсылку("e1cib/data/Документ." + ИмяОбъекта);
...
Функция ЯОткрываюОсновнуюФормуСпискаДокумента(Знач ИмяОбъекта) Экспорт
	...
	ОткрытьФормуЧерезНавигационнуюСсылку("e1cib/list/Документ." + ИмяОбъекта);
...
Функция ЯОткрываюОсновнуюФормуЖурналаДокументов(Знач ИмяОбъекта) Экспорт
	...
	ОткрытьФормуЧерезНавигационнуюСсылку("e1cib/list/ЖурналДокументов." + ИмяОбъекта);
...
Функция ЯОткрываюОсновнуюФормуПланаВидовХарактеристик(Знач ИмяОбъекта) Экспорт
	...
	ОткрытьФормуЧерезНавигационнуюСсылку("e1cib/data/ПланВидовХарактеристик." + ИмяОбъекта);
...
Функция ЯОткрываюОсновнуюФормуСпискаПланаВидовХарактеристик(Знач ИмяОбъекта) Экспорт
	...
	ОткрытьФормуЧерезНавигационнуюСсылку("e1cib/list/ПланВидовХарактеристик." + ИмяОбъекта);
...
Функция ЯОткрываюОсновнуюФормуПланаСчетов(Знач ИмяОбъекта) Экспорт
	...
	ОткрытьФормуЧерезНавигационнуюСсылку("e1cib/data/ПланСчетов." + ИмяОбъекта);
...
Функция ЯОткрываюОсновнуюФормуСпискаПланаСчетов(Знач ИмяОбъекта) Экспорт
	...
	ОткрытьФормуЧерезНавигационнуюСсылку("e1cib/list/ПланСчетов." + ИмяОбъекта);
...
Функция ЯОткрываюОсновнуюФормуПланаВидовРасчета(Знач ИмяОбъекта) Экспорт
	...
	ОткрытьФормуЧерезНавигационнуюСсылку("e1cib/data/ПланВидовРасчета." + ИмяОбъекта);
...
Функция ЯОткрываюОсновнуюФормуСпискаПланаВидовРасчета(Знач ИмяОбъекта) Экспорт
	...
	ОткрытьФормуЧерезНавигационнуюСсылку("e1cib/list/ПланВидовРасчета." + ИмяОбъекта);
...
Функция ЯОткрываюОсновнуюФормуРегистраСведений(Знач ИмяОбъекта) Экспорт
	...
	ОткрытьФормуЧерезНавигационнуюСсылку("e1cib/data/РегистрСведений." + ИмяОбъекта);
...
Функция ЯОткрываюОсновнуюФормуСпискаРегистраСведений(Знач ИмяОбъекта) Экспорт
	...
	ОткрытьФормуЧерезНавигационнуюСсылку("e1cib/list/РегистрСведений." + ИмяОбъекта);
...
Функция ЯОткрываюОсновнуюФормуРегистраНакопления(Знач ИмяОбъекта) Экспорт
	...
	ОткрытьФормуЧерезНавигационнуюСсылку("e1cib/data/РегистрНакопления." + ИмяОбъекта);
...
Функция ЯОткрываюОсновнуюФормуСпискаРегистраНакопления(Знач ИмяОбъекта) Экспорт
	...
	ОткрытьФормуЧерезНавигационнуюСсылку("e1cib/list/РегистрНакопления." + ИмяОбъекта);
...
Функция ЯОткрываюОсновнуюФормуСпискаРегистраБухгалтерии(Знач ИмяОбъекта) Экспорт
	...
	ОткрытьФормуЧерезНавигационнуюСсылку("e1cib/list/РегистрБухгалтерии." + ИмяОбъекта);
...
Функция ЯОткрываюОсновнуюФормуСпискаРегистраРасчета(Знач ИмяОбъекта) Экспорт
	...
	ОткрытьФормуЧерезНавигационнуюСсылку("e1cib/list/РегистрРасчета." + ИмяОбъекта);
...
Функция ЯВыполняюКомандуКомандногоИнтерфейса(Знач ИмяКоманды) Экспорт
	...
	ОткрытьФормуЧерезНавигационнуюСсылку("e1cib/command/" + ИмяКоманды);
...
&НаКлиенте
Процедура ОткрытьФормуЧерезНавигационнуюСсылку(НавсСсылка)
	...
	Для СчетчикПопыток = 1 По КоличествоПопыток Цикл
		Попытка
			...
			АктивноеОкно.ВыполнитьКоманду(НавсСсылка);
