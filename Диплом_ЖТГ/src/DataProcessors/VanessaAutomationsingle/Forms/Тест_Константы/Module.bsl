...
Функция ЯУстанавливаюВКонстантуЗначение(ИмяКонстанты, ЗначениеКонстанты) Экспорт
	ЯУстанавливаюВКонстантуЗначениеНаСервере(ЗначениеКонстанты, ИмяКонстанты);
КонецФункции

&НаСервереБезКонтекста
Функция ЯУстанавливаюВКонстантуЗначениеНаСервере(ЗначениеКонстанты, Знач ИмяКонстанты)
