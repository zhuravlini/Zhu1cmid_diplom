...
Сценарий: Я проверяю корректность формирования отчета "Анализ выставленных актов" от имени бухгалтера
	...
	*И сравниваю отчет с эталоном
	...
	|'Тестовый Контрагент 1'|'Тестовый абонентский договор 1'|	'2 000,00'		 |'2 950,00'		  |	'4 950,00'		  |'500,00'		|
	|'Тестовый Контрагент 2'|'Тестовый абонентский договор 2'|	'1 000,00'		 |'11 000,00'		  |	'12 000,00'		  |'1 000,00'	|
	|'Тестовый Контрагент 3'|'Тестовый абонентский договор 3'|	'3 000,00'		 |'2 175,00'		  |	'5 175,00'		  |'250,00'		|		
