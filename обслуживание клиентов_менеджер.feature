...
| "Тестовый Контрагент 1" | "Тестовый абонентский договор 1" | "Специалист"		 	| '2000'                      | '500'                    |
| "Тестовый Контрагент 2" | "Тестовый абонентский договор 2" | "Менеджер"			| '1000'                      | '1000'                   |
| "Тестовый Контрагент 3" | "Тестовый абонентский договор 3" | "Администратор"		| '3000'                      | '250'                    |
